...
export interface StaffCaseOperationListItem {
  ...
  readonly ownerIsAnonymous: boolean;
  readonly contactFullName: string | null;
  readonly contactEmail: string | null;
  readonly contactEmailVerified: boolean;
  readonly identityClaimedAt: string | null;
...
export interface StaffTotalLossCaseOperation
  ...
  readonly vehicleOptionsPackages: string | null;
  readonly reportProviderName: string | null;
  readonly reportExtractionStatus: string | null;
  ...
  readonly reportStorageObjectPath: string | null;
