...
Validate the preview with `cd frontend && npx tsc -p preview/workspace/tsconfig.json` and `npx vitest run preview/workspace/message-flow.test.ts preview/workspace/response-fixtures.test.ts preview/workspace/stripe-sandbox.test.ts`.
