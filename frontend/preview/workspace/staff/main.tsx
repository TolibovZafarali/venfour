...
applyVisualSystem(location.pathname);
...
import './styles.css';
import { installStaffPreview, paymentApprovalService } from './screen-services';
...
export function Preview() {
  return <>
    <div className="preview-bar">
      ...
      <nav aria-label="Preview shortcuts"><a href="/_local/workspace">All screens</a><Link to="/admin">Overview</Link><Link to="/admin/referral-partners">Referral partners</Link><a href="/_local/businesses">Business journey</a></nav>
