...
describe("workspace palette contract", () => {
  it("uses pure white primary backgrounds and equal-channel grayscale tokens", () => {
  ...
  it("keeps app feature backgrounds free of gradients and tinted literal colors", () => {
    const files = readdirSync("src/features", { recursive: true }).filter(file => file.endsWith(".css"));
    for (const file of files) {
      const css = readFileSync(`src/features/${file}`, "utf8");
